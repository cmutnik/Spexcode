...
def obs_calcedR09_6subplots_overlay():
	...
	# label by lum class
	ax[0,1].annotate( 'Yng', xy=(2, 11.75), color='black' )
	ax[0,1].annotate( 'R09 Dwarfs', xy=(2, 9.75), color='red' )
	ax[0,1].annotate( 'R09 Giants', xy=(2, 7.75), color='orange' )
	ax[0,1].annotate( 'R09 Super Giants', xy=(2, 5.75), color='purple' )
	...
	#plt.show()
	plt.savefig('EW_obs_calcR09_err.png')
